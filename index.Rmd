...
compmus_long_distance(
  pray_dtw |> mutate(pitches = map(pitches, compmus_normalise, "chebyshev")),
  deft_dtw |> mutate(pitches = map(pitches, compmus_normalise, "chebyshev")),
  feature = pitches,
  method = "euclidean"
) |>
  ggplot(
  ...
  geom_tile() +
  coord_equal() +
  labs(x = "Pray", y = "Be quiet and drive (far away)") +
  theme_minimal() +
